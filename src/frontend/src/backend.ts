...
import type { Contestant as _Contestant, ContestantId as _ContestantId, ExternalBlob as _ExternalBlob, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addContestant(arg0: string, arg1: string, arg2: ExternalBlob | null): Promise<ContestantId> {
        if (this.processError) {
            try {
                const result = await this.actor.addContestant(arg0, arg1, await to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async claimFirstAdminRole(): Promise<void> {
        if (this.processError) {
            try {
                await this.actor.claimFirstAdminRole();
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async checkVote(): Promise<ContestantId | null> {
        if (this.processError) {
            try {
                const result = await this.actor.checkVote();
    ...
    async getAllContestants(): Promise<Array<Contestant>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContestants();
    ...
    async getAllContestantsWithVotes(): Promise<Array<[Contestant, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContestantsWithVotes();
    ...
    async getContestant(arg0: ContestantId): Promise<Contestant | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getContestant(arg0);
    ...
    async removeContestant(arg0: ContestantId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeContestant(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateContestant(arg0: ContestantId, arg1: string, arg2: string, arg3: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateContestant(arg0, arg1, arg2, await to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async vote(arg0: ContestantId): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_Contestant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Contestant): Promise<Contestant> {
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContestantId]): ContestantId | null {
...
async function from_candid_opt_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Contestant]): Promise<Contestant | null> {
    return value.length === 0 ? null : await from_candid_Contestant_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        videoUrl: record_opt_to_undefined(await from_candid_opt_n16(_uploadFile, _downloadFile, value.videoUrl))
    };
}
...
async function from_candid_tuple_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_Contestant, bigint]): Promise<[Contestant, bigint]> {
    return [
        await from_candid_Contestant_n14(_uploadFile, _downloadFile, value[0]),
        value[1]
    ];
}
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Contestant>): Promise<Array<Contestant>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Contestant_n14(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_Contestant, bigint]>): Promise<Array<[Contestant, bigint]>> {
